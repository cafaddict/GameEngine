...
class VulkanVertexBuffer_refac : public VulkanBuffer_refac {
    public:
    VulkanVertexBuffer_refac() = default;
    VulkanVertexBuffer_refac(std::vector<VulkanVertex> &vertices, std::shared_ptr<VulkanDevice> device,
                             std::shared_ptr<VulkanCommandBuffer> transferCommandBuffer);
    ~VulkanVertexBuffer_refac();
...
class VulkanIndexBuffer_refac : public VulkanBuffer_refac {
    public:
    VulkanIndexBuffer_refac() = default;
    VulkanIndexBuffer_refac(std::vector<uint32_t> &indices, std::shared_ptr<VulkanDevice> device,
                            std::shared_ptr<VulkanCommandBuffer> transferCommandBuffer);
    ~VulkanIndexBuffer_refac();
...
template <typename T> class VulkanUniformBuffer_refac : public VulkanBuffer_refac {
    public:
    VulkanUniformBuffer_refac() = default;
    VulkanUniformBuffer_refac(std::shared_ptr<T> data, std::shared_ptr<VulkanDevice> device,
                              std::shared_ptr<VulkanCommandBuffer> transferCommandBuffer);
    ~VulkanUniformBuffer_refac();
    std::vector<VkBuffer> getBuffer() const { return m_Buffers; }
...
template <typename T> class VulkanShaderStorageBuffer_refac : public VulkanBuffer_refac {
    public:
    VulkanShaderStorageBuffer_refac() = default;
    VulkanShaderStorageBuffer_refac(std::vector<T> &objects, std::shared_ptr<VulkanDevice> device,
                                    std::shared_ptr<VulkanCommandBuffer> transferCommandBuffer);
    ~VulkanShaderStorageBuffer_refac();
    std::vector<VkBuffer> getBuffer() const { return m_Buffers; }
...
template <typename T>
VulkanUniformBuffer_refac<T>::VulkanUniformBuffer_refac(std::shared_ptr<T> data, std::shared_ptr<VulkanDevice> device,
                                                        std::shared_ptr<VulkanCommandBuffer> transferCommandBuffer)
...
template <typename T> VulkanUniformBuffer_refac<T>::~VulkanUniformBuffer_refac() {
    for (int i = 0; i < MAX_FRAME_IN_FLIGHT; i++) {
...
template <typename T> void VulkanUniformBuffer_refac<T>::updateData(std::shared_ptr<T> data, uint32_t currentFrame) {
    memcpy(m_BuffersMapped[currentFrame], data->getData(), sizeof(data));
}

template <typename T>
VulkanShaderStorageBuffer_refac<T>::VulkanShaderStorageBuffer_refac(
    std::vector<T> &objects, std::shared_ptr<VulkanDevice> device,
    std::shared_ptr<VulkanCommandBuffer> transferCommandBuffer)
...
template <typename T> VulkanShaderStorageBuffer_refac<T>::~VulkanShaderStorageBuffer_refac() {
...
template <typename T>
void VulkanShaderStorageBuffer_refac<T>::updateData(std::vector<T> &objects, uint32_t currentFrame) {
