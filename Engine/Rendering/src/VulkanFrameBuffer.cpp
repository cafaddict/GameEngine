...
void VulkanFrameBuffer::createFrameBuffer() {
    ...
    m_ColorImage = std::make_shared<VulkanImage>(m_Device, colorImageInfo, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, VK_IMAGE_ASPECT_COLOR_BIT);
    ...
    m_DepthImage = std::make_shared<VulkanImage>(m_Device, depthImageInfo, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, VK_IMAGE_ASPECT_DEPTH_BIT);
