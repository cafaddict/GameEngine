...
#define BIND_EVENT_FN(x) std::bind(&ImGuiLayer::x, this, std::placeholders::_1)
    ...
    ImGuiLayer::ImGuiLayer(std::shared_ptr<Engine::EntityManager> entityManager, std::shared_ptr<Engine::AssetManager> assetManager) : Engine::Layer("ImGui Layer"), m_EntityManager(entityManager), m_AssetManager(assetManager) {}
